...
public class MetricsLite {
	 ...
	 */
	private final String BASE_URL = "http://mcstats.org";

	/**
	 * The url used to report a server's status
	 */
	private final String REPORT_URL = "/report/%s";
	 ...
	 *            the value
	 */
	private void encodeDataPair(final StringBuilder buffer, final String key, final String value) throws UnsupportedEncodingException {
